...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    CHIP3G_stability_2 = pipeline(
        [
            ...
            node(
                func=partial(create_stability_plot, t_max_h=50.0, y_lim=(3, 5)),
    ...
    CHIP3G_stability_new = pipeline(
        [
            ...
            node(
                func=create_stability_plot_new,
            ...
            node(
                func=create_double_exp_fit_plot,
            ...
            node(
                func=create_stretched_exp_fit_plot,
